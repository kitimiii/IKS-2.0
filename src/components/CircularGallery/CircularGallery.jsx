...
// Import der Bilder
import Arabic from '../../assets/slider-image/Arabic.jpg';
import Articel from '../../assets/slider-image/Articel.jpg';
import Regel from '../../assets/slider-image/Regel.jpg';
import buchstaben from '../../assets/slider-image/buchstaben.jpg';
import dokument from '../../assets/slider-image/dokument (1).jpg';
...
class App {
    ...
    createMedias(items, bend = 1, textColor, borderRadius, font) {
        const defaultItems = [
            { image: Arabic, text: 'text' },
            { image: Articel, text: 'text' },
            { image: Regel, text: 'text' },
            { image: buchstaben, text: 'text' },
            { image: dokument, text: 'text' },
            { image: japan, text: 'text' },
            { image: schreiben, text: 'text' },
            { image: schrift, text: 'text' },
            { image: tisch, text: 'text' },
            { image: wand, text: 'text' },
            { image: werkzeug, text: 'text' },
            { image: zitat, text: 'text' }
        ];
